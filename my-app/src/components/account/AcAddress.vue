      ...
      <div class="gray-box clear">
        <div class="title pre-title">
          ...
          <span class="gray-blue-btn js-add-address">
            <a class="add" @click="showPop(-1)">添加新地址</a>
          </span>
        </div>
          ...
          >
            ...
            <div class="operation fn-right">
              <div class="operation-cell">
                <a class="gray-edit-btn js-edit-address" @click="showPop(index)">修改</a>
                <span class="red-del-btn js-del-address" @click="addressDel(index)">
                  <a>删除</a>
                </span>
              </div>
            </div>
            <div class="default fn-right">
                ...
                <a v-else @click="setDefaultFn(index)">(设为默认)</a>
            </div>
...
export default {
  ...
  methods: {
    ...
    setDefaultFn(i){
      this.$store.commit('setDefaultMut',i)
    }
  }
}
</script>
...
.gray-edit-btn {
  display: inline-block;
  background: url(../../assets/img/btn-icon-new.png) -9px -112px no-repeat
    #a2a2a2;
  text-indent: -9999em;
}
